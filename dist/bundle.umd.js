(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.VueKinescopePlayer = {}, global.Vue));
  ...
  var script = {
    ...
    setup: function setup(props, _ref) {
      var emit = _ref.emit,
        expose = _ref.expose;
      var playerRef = vue.ref(null);
      var playerLoad = vue.ref(false);
      ...
      var propsChanged = vue.computed(function () {
        return {
      ...
      vue.watch(propsChanged, updatePlayer);
      vue.onMounted(function () {
        if (playerLoad.value) {
          create();
        }
  ...
  function render(_ctx, _cache, $props, $setup, $data, $options) {
    var _component_Loader = vue.resolveComponent("Loader");
    return vue.openBlock(), vue.createBlock(_component_Loader, {
      onJsLoad: $setup.handleJsLoad,
      onJsLoadError: $setup.handleJsLoadError
    }, {
      default: vue.withCtx(function () {
        return [vue.createElementVNode("div", _hoisted_1, null, 512 /* NEED_PATCH */)];
      }),
      _: 1 /* STABLE */
  ...
  exports.KinescopePlayer = script;
